...
export const HeroSection = () =>{
    return <section id="hero" className="min-h-screen flex flex-col items-center justify-center px-4">
        ...
        <p className="mt-5 animate-fade-in-delay-3 opacity-0 max-w-3xl" >Always eager to learn and expand my skills, I am ready to take on new challenges, collaborate with others, and passionately turn ideas into meaningful projects and real-world solutions.</p>
